  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          {[
            { href: "https://github.com/Affanraza2002", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://linkedin.com/in/affanraza202", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" },
            { href: "mailto:razaaffan08@gmail.com", icon: "material-icon-theme:email", label: "Email", color: "hover:text-green-600" }
          ].map((link) => (
